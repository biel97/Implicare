...
class AlterarExperienciaProfissional {
    ...
    static String execute(HttpServletRequest request) {
        ...
        try {
            ...
            java.util.Date Dat_Inicio = formato.parse(request.getParameter("Data_Inicio"));
            java.sql.Date Data_Inicio = convertUtilToSql(Dat_Inicio);
            java.util.Date Dat_Termino = formato.parse(request.getParameter("Data_Termino"));
            java.sql.Date Data_Termino = convertUtilToSql(Dat_Termino);            
            ...
            Exp.setData_Inicio(Data_Inicio);
    ...
    private static Date convertUtilToSql(java.util.Date Dat_Inicio) {
